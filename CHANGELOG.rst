^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package custom_effort_controllers
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* custom_effort_controllers: fix minor typo in setGains doc
...
* custom_effort_controllers::joint_velocity_controller was not being built
